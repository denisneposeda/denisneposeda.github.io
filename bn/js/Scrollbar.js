...
; (function ($, window, document, undefined) {
    ...
    function calculateCurrentPosition() {
        ...
        if (index === 0) {
            ...
            position = (ratio * index) + ($handle.width() / 2 * index);
        }
        else {
            position = sbSize - progressSize - $handle.width();
        }
    ...
    function initialize(event) {
        ...
        ratio = sbSize / (count - visible + 1) - $handle.width() / (count - visible + 1);
